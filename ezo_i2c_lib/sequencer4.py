class Sequencer4:
    ...
    def __init__(self, step1_func, time1, step2_func, time2,
                 step3_func, time3, step4_func, time4):
        """
        Initializes the Sequencer with four step functions and their respective time intervals.
        ...
        :param step4_func: Function to execute at step 4.
        :param time4: Time interval for step 4 in milliseconds.
        """
        self.t1 = time1
        self.t2 = time2
        self.t3 = time3
        self.t4 = time4
        self.s1func = step1_func
        self.s2func = step2_func
        self.s3func = step3_func
        self.s4func = step4_func
    ...
    def set_step4_time(self, time):
        """
        Updates the time interval for step 4.
        :param time: New time interval for step 4 in milliseconds.
        """
        self.t4 = time
    ...
    def get_step4_time(self):
        """
        Returns the time interval for step 4.
        :return: Time interval for step 4 in milliseconds.
        """
        return self.t4
    ...
    def run(self):
        ...
        Alternates between step 1, step 2, step 3, and step 4 based on their timing.
        """
        ...
        if self.current_step == self.ReadingStep.STEP1:
            ...
            if current_time >= self.next_step_time:
                ...
                self.current_step = self.ReadingStep.STEP4  # Switch to step 4

        elif self.current_step == self.ReadingStep.STEP4:
            if current_time >= self.next_step_time:
                self.s4func()  # Call step 4 function
                self.next_step_time = current_time + self.t4  # Schedule next step 4
